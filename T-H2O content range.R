...
T_values = seq(from = 800, to = 900, by = 20) #Set min ('from'), max ('to') and increment ('by') for sequence. 
...
# Save results from testing a range of water contents (take out # to include models or add in # to remove unused models)
OUTPUT3 <- cbind(H2Orange_input1, 
                 Trange_input1,
                 TwH2Oliq_median,TwH2Oliq_sd, 
                 Pliq_median,Pliq_sd)
write_xlsx(OUTPUT3,"eruption_T-H2Orange.xlsx")
...
# Save filtered file
write_xlsx(filtered_OUTPUT3,"eruption_T-H2Orange_filtered.xlsx")
